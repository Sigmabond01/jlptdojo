        ...
        <section className="relative py-20 bg-gray-400 dark:bg-black text-black dark:text-white overflow-hidden">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6">
                <div className="text-center mb-16">
                    <h2 className="text-4xl md:text-7xl font-bold mb-4 tracking-tight">Choose Your Path</h2>
                ...
                <div className="grid md:grid-cols-3 gap-8 scale-95">
                    {plans.map((plan) => (
                        <div key={plan.name}
                            className={`relative group transition-all duration-700 ${plan.highlight ? 'md:-transalte-y-4' : ''
                                }`}
                            onMouseEnter={() => setHovered(plan.name)}
                            onMouseLeave={() => setHovered(null)}>
                            <div className={`relative p-8 rounded-2xl border-2 transition-all duration-700 ${plan.highlight
                                ...
                                <button
                                    className={`relative w-full py-4 rounded-xl font-bold tracking-wide transition-all duration-500 overflow-hidden group/btn ${plan.highlight
