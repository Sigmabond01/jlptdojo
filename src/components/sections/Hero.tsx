...
export default function Hero() {
  return (
    <div className="relative min-h-screen bg-gray-400 dark:bg-black">
      <Pattern />
      <div className="relative z-50 backdrop-blur-[1px] flex pt-44 min-h-screen p-4">
        <Header />
        <div className="text-center mb-8 ml-8">
          ...
          <div className='fixed'>
            <p className="mt-4 ml-24 text-center text-xl font-semibold dark:text-white text-black">
              A focused platform built to help you train, test, and master every JLPT level
            </p>
          </div>
          <div className='fixed right-20 bottom-32'>
            <DojoText />
          </div>

          <div className='space-x-4 pt-18 text-xl ml-48 fixed flex items-center justify-center max-w-4xl'>
